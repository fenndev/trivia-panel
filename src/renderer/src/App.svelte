...
<div class="container">
    ...
    <h2 class="hero-text">You've successfully created an Electron project with Svelte and TypeScript</h2>
    ...
    <div class="links">
        ...
        <div class="link-item link-dot">•</div>
        <div class="link-item">
            <a rel="noopener noreferrer" target="_blank" href="https://github.com/alex8088/quick-start/tree/master/packages/create-electron"> create-electron </a>
        </div>
    </div>
